...
def mann_whitney_plus_means(turnstile_weather):
    ...
    with_rain_mean = np.mean(data_rain)
    data_no_rain = turnstile_weather[turnstile_weather['rain']==0]['ENTRIESn_hourly']
    without_rain_mean = np.mean(data_no_rain)
    
    U,p = scipy.stats.mannwhitneyu(data_rain, data_no_rain)
