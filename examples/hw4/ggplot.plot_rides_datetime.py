...
def plot_weather_data(turnstile_weather):
    ...
    date_grouped = turnstile_weather.groupby('DATEn', as_index=False).mean()
    plot = gp.ggplot(date_grouped, gp.aes(x='DATEn', y='ENTRIESn_hourly')) + gp.geom_point(color='red') + gp.geom_line(color='red')
    return plot
